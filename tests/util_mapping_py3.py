# taken from Lib/test/mapping_tests.py of https://github.com/python/cpython
...
class BasicTestMappingProtocol(unittest.TestCase):
    ...
    def test_bool(self):
        print(self.type2test)
        print(self._empty_mapping())
        print(bool(self._empty_mapping()))
    ...
    # no test_fromkeys or test_copy as both os.environ and selves
    # don't support it
